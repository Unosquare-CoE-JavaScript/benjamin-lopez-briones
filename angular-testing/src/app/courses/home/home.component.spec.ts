...
describe('HomeComponent', () => {
  ...
  it("should display advanced courses when tab clicked - feik", fakeAsync(() => {
    coursesService.findAllCourses.and.returnValue(of(setupCourses()));
    fixture.detectChanges();
    ...
    expect(cardTitles[0].nativeElement.textContent).toContain("Angular Security");
  }));

  it("should display advanced courses when tab clicked - 100% rial", waitForAsync(() => {
    coursesService.findAllCourses.and.returnValue(of(setupCourses()));
    fixture.detectChanges();
